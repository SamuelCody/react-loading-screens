...
const Skeleton = (props) => {
  ...
  if (props.type === "feed") return Array(COUNTER).fill(<FeedSkeleton />);
  if (props.type === "top") return <TopSkeleton />;
  if (props.type === "menu") return <MenuSkeleton />;
  if (props.type === "circle") return <Circle />;
  if (props.type === "custom") return <CustomLoading />;
};
